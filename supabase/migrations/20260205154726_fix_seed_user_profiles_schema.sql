/*
  # Fix Seed Function - Remove full_name

  Updates seed function to only use display_name (no full_name column exists)
*/
...
BEGIN
  ...
  -- Create health metrics (182 readings: 7 days × 3 metrics × 8 residents + 14 glucose)
  FOR i IN 1..8 LOOP
    FOR j IN 0..6 LOOP
