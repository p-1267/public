/*
  # Recreate Simulation Data Summary RPC

  ## Purpose
  Drop and recreate simulation summary RPC for parity test suite.
*/
...
BEGIN
  v_result := jsonb_build_object(
    ...
    'audit_log', (SELECT COUNT(*) FROM audit_log WHERE agency_id = p_agency_id AND is_simulation = true)
  );
