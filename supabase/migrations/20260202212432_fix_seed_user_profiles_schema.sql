/*
  # Fix Seed Function - Remove full_name Column
  
  Updates seed function to match actual user_profiles schema.
*/
...
BEGIN
  ...
  FOR i IN 1..10 LOOP
    ...
    INSERT INTO user_profiles (id, role_id, agency_id, display_name, is_active, created_at, updated_at)
    VALUES (
      v_user_id,
      v_caregiver_role_id,
      v_agency_id,
