/*
  # Fix seed_active_context appointment_type enum

  **BLOCKER:** 'LAB_TEST' not valid, use 'SCREENING'
  **FIX:** Update appointment_type to valid enum value
*/
...
BEGIN
  ...
  -- FIXED: Use SCREENING instead of LAB_TEST
