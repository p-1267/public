/*
  # Fix WP8 Showcase Seeder - Use provider_device_id (text) instead of device_id (uuid)
  
  device_id is uuid (nullable)
  provider_device_id is text - use this for string identifiers
*/
