...
BEGIN
  ...
  INSERT INTO user_profiles (id, role_id, agency_id, display_name, is_active) VALUES
  ...
  INSERT INTO resident_medications (resident_id, medication_name, dosage, frequency, route, schedule, prescriber_name, is_active, start_date, entered_by) VALUES
  ...
  INSERT INTO device_registry (id, device_id, resident_id, device_type, device_name, manufacturer, model, firmware_version, battery_level, trust_state, capabilities, pairing_actor, pairing_timestamp) VALUES (
    gen_random_uuid(), 'OMRON-BP-SHOWCASE', v_resident_id, 'BLE_HEALTH_SENSOR', 'OMRON Evolv', 'OMRON', 'BP7900', '2.1.4', 85, 'TRUSTED',
    '{"supported_metrics": ["BLOOD_PRESSURE_SYSTOLIC", "BLOOD_PRESSURE_DIASTOLIC", "HEART_RATE"]}'::jsonb, v_senior_user_id, now() - interval '30 days'
  ) ON CONFLICT (device_id) DO UPDATE SET battery_level = EXCLUDED.battery_level RETURNING id INTO v_device_id;
