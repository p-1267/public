/*
  # Fix seed_active_context - remove incompatible health_metric_trends insert

  **BLOCKER:** health_metric_trends schema mismatch (period, sample_count required)
  **FIX:** Remove health_metric_trends insert (it's for aggregated data, not seed data)
*/
