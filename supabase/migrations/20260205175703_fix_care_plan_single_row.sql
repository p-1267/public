/*
  # Fix Care Plan - Only 1 Row Per Resident
  
  resident_care_plan_anchors has UNIQUE constraint on resident_id
*/
...
BEGIN
  ...
  -- Care Plan Anchor (1 only - unique constraint on resident_id)
  ...
  RETURN jsonb_build_object(
    'status', 'SUCCESS',
    'message', 'Senior + Family scenario COMPLETE - all data seeded',
