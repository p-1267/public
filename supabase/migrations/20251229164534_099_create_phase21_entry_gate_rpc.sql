/*
  # Phase 21 Entry Gate RPC (Phase 21)

  ## Purpose
  Checks if user can enter Phase 21 (Device & Hardware Management).
  ...
  4. Phase 20 = COMPLETED (at least one sealed baseline exists)
  5. User role ∈ {AGENCY_ADMIN, SUPERVISOR}

  ## Function
  - check_phase21_entry_gate() - Returns allow/block with detailed reasons
...
-- Function: check_phase21_entry_gate
-- Checks if current user can enter Phase 21
CREATE OR REPLACE FUNCTION check_phase21_entry_gate()
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
