/*
  # Complete Working Seed with ALL Required Fields

  Includes:
  - Medications: prescriber_name, schedule, is_prn, is_controlled, entered_by
  - Appointments: title
  - Auto-calculated health_metric_trends
*/
