/*
  # Fix Voice Commit Function - Correct Enum Values
  
  Fixes:
  - tasks.priority: 'normal' → 'medium', 'urgent' → 'critical'
  - medication_administration_log.status: 'administered' → 'TAKEN'
  - observation_events.caregiver_id: allow NULL for showcase/voice actions
*/
