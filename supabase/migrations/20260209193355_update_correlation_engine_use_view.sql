/*
  # Update Correlation Engine to Use resident_signal_facts View
  
  Rewrites run_correlation_engine to query only resident_signal_facts view
*/
...
BEGIN
  ...
  LOOP
    ...
    -- Count medication signals using unified view
    ...
    -- Count abnormal vital signs using unified view
    ...
    -- Count urgent family observations using unified view
    ...
    IF v_rule.rule_name = 'medication_adherence_vitals_pattern' THEN
      IF v_med_late_count >= 2 AND v_vitals_abnormal_count >= 1 THEN
        ...
        -- Collect all signal IDs from unified view
        ...
        -- Link all contributing signals using unified view
    ...
    -- Additional correlation rules can be added here
    -- e.g., family_concern_vitals_pattern, family_concern_med_adherence_pattern, etc.
