/*
  # Add Correlation Tracking to Voice Action Commit
  
  Store draft_id and confirmation_id in created rows for audit lineage.
  This proves the DB write was created BY that specific confirmation.
*/
...
BEGIN
  ...
  -- Generate confirmation ID early for correlation tracking
