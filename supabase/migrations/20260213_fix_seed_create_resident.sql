/*
  # Fix seed_active_context to create showcase resident if missing

  ## Changes
  - Create resident 'b0000000-0000-0000-0000-000000000001' if not exists
  - Remove hard failure when resident not found

  ## Fixes
  - Loading lock: seed_active_context now succeeds even if resident doesn't exist yet
*/
...
BEGIN
  ...
  IF NOT FOUND THEN
    -- Create the showcase resident if it doesn't exist
