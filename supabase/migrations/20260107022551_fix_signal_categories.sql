/*
  # Fix Signal Categories
  
  Updates to use correct category values
*/
...
BEGIN
  ...
  VALUES
    ('sig-med-timing-001', v_resident_ids[1], v_agency_id, 'pattern_deviation', 'Unusual Medication Timing',
    ...
    ('sig-nutrition-001', v_resident_ids[1], v_agency_id, 'health_trend', 'Declining Meal Intake',
    ...
    ('sig-mobility-002', v_resident_ids[2], v_agency_id, 'positive_outcome', 'Improved Mobility',
  ...
  VALUES
    ...
    (v_resident_ids[2], now() - interval '3 hours', 118, 76, 68, 14, 98.6, 98, 105,
     'Excellent vitals. Blood glucose slightly elevated but acceptable.', now());
  ...
  RETURN jsonb_build_object(
    ...
    'vitals', (SELECT COUNT(*) FROM vital_signs WHERE resident_id = ANY(v_resident_ids)),
