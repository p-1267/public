/*
  # Fix seed to use correct resident_medications schema

  Changes:
  - prescriber -> prescriber_name
  - Add schedule (empty jsonb)
  - Add is_prn (false)
  - Add is_controlled (false)
  - Add entered_by (use caregiver1 ID)
  - Use uppercase frequency values: DAILY, TWICE_DAILY
*/
