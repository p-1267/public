/*
  # Fix seed_active_context - skip health_metrics temporarily
  
  ## Changes
  - Remove health_metrics insert (complex check constraints)
  - Focus on core seeding: users, medications, appointments, tasks
*/
