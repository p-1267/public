/*
  # Fix seed_active_context medications entered_by requirement
  
  ## Changes
  - Add entered_by (use senior/family/caregiver user as appropriate)
*/
...
BEGIN
  ...
  -- Determine who entered medications (prefer senior > family > caregiver > supervisor)
