/*
  # Comprehensive Showcase Seed with User Profiles
  
  ## Complete Setup for WP1-8 Testing
  
  Creates:
  - Agency
  - Departments (3)
  - User profiles (10 caregivers, 2 supervisors, 1 admin)
  - Residents (20)
  - Task categories (4)
  - Tasks (30 unassigned for TODAY)
  - Department personnel links
  
  All data seeded for showcase agency: a0000000-0000-0000-0000-000000000001
*/
...
BEGIN
  ...
  -- Delete existing showcase data (in correct order due to FKs)
  ...
  -- Create user profiles for caregivers (10 caregivers for testing)
  FOR i IN 1..10 LOOP
    v_user_id := gen_random_uuid();
    INSERT INTO user_profiles (id, role_id, agency_id, display_name, full_name, is_active, created_at, updated_at)
    VALUES (
      v_user_id,
      v_caregiver_role_id,
      v_agency_id,
  ...
  v_result := jsonb_build_object(
    ...
    'personnel_created', array_length(v_caregiver_ids, 1) + array_length(v_supervisor_ids, 1) + 1,
