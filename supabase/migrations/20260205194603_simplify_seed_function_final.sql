/*
  # Simplify Seed - Delete and Insert Fresh

  Remove all ON CONFLICT clauses that depend on constraints that don't exist.
  Use DELETE + INSERT pattern for idempotency.
*/
