/*
  # Comprehensive Senior/Family Seed - Complete All Tables
  
  ## Purpose
  Populate ALL tables required for Senior + Family modules to render data.
  
  ## Tables Populated
  - resident (1)
  - resident_medications (2)
  - appointments (3)
  - lab_tests (3)
  - documents (3)
  - resident_care_plan_anchors (2)
  - resident_emergency_contacts (3)
  - notification_log (5)
  - message_threads + messages (2 threads, 4 messages)
  - health_metric_trends (72 hours of data)
  - device_registry (2 devices - without FK constraints)
  
  ## No Mock Logic - All Real Database
*/
...
BEGIN
  ...
  VALUES 
    ...
    ('e0000000-0000-0000-0000-000000000002'::uuid, v_resident_id, 'LAB_WORK', 'Routine Blood Work',
     (now() + interval '14 days')::timestamp, 30, 'SCHEDULED', 'LabCorp', 'Downtown Lab'),
    ('e0000000-0000-0000-0000-000000000003'::uuid, v_resident_id, 'SPECIALIST', 'Cardiology Follow-up',
