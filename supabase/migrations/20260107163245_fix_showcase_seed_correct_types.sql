/*
  # Fix Showcase Seed - Correct Category Types
  
  Uses valid category_type values
*/
...
BEGIN
  ...
  -- Create task categories with correct types
  ...
  FOR v_day_offset IN 0..6 LOOP
    ...
    -- Vital signs monitoring (2 PM) for high acuity
    FOR v_resident_id IN 
      SELECT id FROM residents 
      WHERE agency_id = v_agency_id 
