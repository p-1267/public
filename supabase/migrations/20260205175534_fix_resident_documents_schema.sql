/*
  # Fix Resident Documents Schema in Seed
  
  Add required fields: file_name, storage_path, uploaded_by
*/
...
BEGIN
  ...
  -- Resident Documents (3) - FIXED: added file_name, storage_path, uploaded_by
  ...
  -- Vital Signs (FIXED: Full 72 hours)
  FOR i IN 0..71 LOOP
    v_timestamp := now() - (i || ' hours')::interval;
    
    -- BP readings 3x per day
