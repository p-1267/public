/*
  ...
  Use valid UUIDs (hex digits only: 0-9, a-f)
*/
...
BEGIN
  ...
  -- FIXED: Use valid UUID (0-9, a-f only, no 'g')
  v_thread_id := 'f0000000-0000-0000-0000-000000000001'::uuid;
  ...
  VALUES
    ...
    ('f0000000-0000-0000-0000-000000000002'::uuid, v_agency_id, 'FAMILY', v_resident_id, 
  ...
  VALUES
    ...
    ('f0000000-0000-0000-0000-000000000002'::uuid, 'FAMILY', v_senior_user_id, 'SENIOR', 'text', 'TEXT',
     'I noticed my new Metformin bottle says to take with meals. Is morning and evening okay?', now() - interval '3 days 2 hours'),
    ('f0000000-0000-0000-0000-000000000002'::uuid, 'FAMILY', v_family_user_id, 'FAMILY_ADMIN', 'text', 'TEXT',
