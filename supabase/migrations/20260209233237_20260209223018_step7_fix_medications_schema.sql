/*
  # Step 7: Fix resident_medications schema
  
  Changes:
  - Use route instead of route_used
  - Use prescriber_name instead of prescribing_physician
  - Add entered_by (required)
  - Add schedule (required jsonb)
  - Add is_prn and is_controlled (required booleans)
*/
