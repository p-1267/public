/*
  # Fix REQUEST - Use resident_id for context, mark as agency-level in metadata
  
  REQUEST tasks use resident context but are agency-level (distinguished by metadata)
*/
...
BEGIN
  ...
  IF p_user_id IS NULL THEN
    ...
    v_user_id_for_insert := v_system_user_id;
  ELSE
    v_user_id_for_insert := p_user_id;
  END IF;
