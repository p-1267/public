/*
  # Fix seed_active_context medication schedule to use jsonb format

  ## Change
  - Change schedule from text to jsonb format
  - Schedule should be jsonb array like: '["09:00"]'::jsonb

  ## Fixes
  - ERROR: invalid input syntax for type json - Token "09" is invalid
*/
