/*
  # Fix seed_active_context metric_category enum values

  **BLOCKER:** 'VITAL' is not valid, must use specific categories
  **FIX:** Use correct metric_category values from CHECK constraint
*/
...
BEGIN
  ...
  FOR i IN 0..4 LOOP
    ...
    -- FIXED: Use correct metric_category values
