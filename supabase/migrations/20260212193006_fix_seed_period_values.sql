/*
  # Fix health_metric_trends period values
*/
...
BEGIN
  ...
  INSERT INTO resident_documents (resident_id, title, storage_path, uploaded_by) VALUES (v_resident.id, 'Care Plan', '/documents/care-plan.pdf', COALESCE(v_admin_user_id, v_senior_user_id)), (v_resident.id, 'Medical History', '/documents/medical-history.pdf', COALESCE(v_admin_user_id, v_senior_user_id)) ON CONFLICT DO NOTHING;
