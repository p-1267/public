/*
  # Minimal Working Seed - Core Data Only

  ## Focus
  - Users, resident, links
  - Departments and personnel
  - Tasks and task categories
  - Medications (critical for Senior pages)
  - Appointments (critical for Senior pages)
  - Lab tests
  - Health metrics (critical for Health Dashboard)
  - Device registry
*/
...
'Senior/Family scenario seed with core operational data.';
