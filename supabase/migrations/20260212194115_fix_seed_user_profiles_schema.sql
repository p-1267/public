/*
  # Fix user_profiles INSERT schema

  Changes user_profiles INSERT to match actual schema:
  - Use role_id (required, lookup from roles table)
  - Use display_name instead of full_name, email, etc
  - Remove non-existent columns: email, phone_number, employee_id, emergency_contact fields
  - Lookup users by display_name for subsequent queries
*/
