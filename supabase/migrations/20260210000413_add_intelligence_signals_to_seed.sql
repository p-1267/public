/*
  # Add intelligence signals to seed_senior_family_scenario
  
  1. Changes
    - Add intelligence signals to demonstrate brain intelligence
    - Add observation events to show data flowing through system
  
  2. Notes
    - Makes intelligence visible in UI
    - Shows compound intelligence working
*/
...
BEGIN
  ...
  INSERT INTO intelligence_signals (
    resident_id, agency_id, category, severity, title, description,
    reasoning, data_source, suggested_actions, requires_human_action,
    detected_at, dismissed
  )
  VALUES
    (v_senior_resident_id, v_agency_id, 'HEALTH_MONITORING', 'MEDIUM', 
    ...
    (v_senior_resident_id, v_agency_id, 'MEDICATION_ADHERENCE', 'LOW',
