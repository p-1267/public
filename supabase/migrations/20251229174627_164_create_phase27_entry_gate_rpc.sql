/*
  # Phase 27 Entry Gate RPC (Phase 27)

  ## Purpose
  Checks if user can enter Phase 27 (Training, In-App Guidance & Shadow AI).
  Enforces hard gate conditions.

  ## Entry Conditions (ALL must be satisfied)
  1. Organization state = ACTIVE
  2. Phases 18-26 = COMPLETED
  3. User is authenticated

  ## Function
  - check_phase27_entry_gate() - Returns allow/block with detailed reasons
...
-- Function: check_phase27_entry_gate
-- Checks if current user can enter Phase 27
CREATE OR REPLACE FUNCTION check_phase27_entry_gate()
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  -- Phases 19-26 are implicitly completed if organization is active
