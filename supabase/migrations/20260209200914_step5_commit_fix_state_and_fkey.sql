/*
  # STEP 5: Fix tasks.state and medication administered_by foreign key
  
  - tasks.state: use 'scheduled' instead of 'pending'
  - medication_administration_log.administered_by: use NULL to avoid FK violation
*/
