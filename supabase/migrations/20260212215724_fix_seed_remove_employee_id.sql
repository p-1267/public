/*
  # Fix seed_active_context remove employee_id

  Removes employee_id references from user_profiles inserts.
  user_profiles table does not have employee_id column.
*/
