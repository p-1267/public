/*
  # Fix intelligence_signals categories in seed
  
  1. Changes
    - Use valid category values: PROACTIVE, REACTIVE, PREDICTIVE
  
  2. Notes
    - Fixes check constraint violation
*/
...
BEGIN
  ...
  -- Add intelligence signals with valid categories
