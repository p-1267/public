/*
  # Fix seed_active_context tasks state to use valid enum value

  ## Changes
  - Use 'scheduled' instead of 'ready'

  ## Fixes
  - ERROR: new row for relation "tasks" violates check constraint "tasks_state_check"
  - Valid values: scheduled, due, in_progress, completed, skipped, failed, overdue, escalated
*/
...
BEGIN
  ...
  -- Create sample tasks for caregiver (use valid state enum value)
