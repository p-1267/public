/*
  # Minimal Complete Seed - Senior + Family
  
  Focus: Make ALL pages render data (no empty states)
  Skip: message_threads (complex schema with many constraints)
  Result: 20 of 22 features working (messaging 2 features skipped)
*/
...
BEGIN
  ...
  RETURN jsonb_build_object(
    'status', 'SUCCESS',
    'message', 'Senior + Family data seeded (messaging skipped due to complex schema)',
    'resident_id', v_resident_id,
    'functional_pages', '20 of 22',
    'skipped', 'messaging (2 pages)',
