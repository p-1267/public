/*
  # Step 7: Fix metric_category to use valid enum values
  
  Changes:
  - Update seed_senior_family_scenario() to use 'BLOOD_PRESSURE' instead of 'vitals'
  - Use 'CARDIOVASCULAR' for heart_rate
*/
...
BEGIN
  ...
  -- Create resident
  INSERT INTO residents (id, agency_id, first_name, last_name, date_of_birth, room_number)
  VALUES (gen_random_uuid(), v_agency_id, 'Eleanor', 'Martinez', '1945-03-15', '201')
