/*
  # Fix seed_active_context - remove intelligence_signals insert

  **BLOCKER:** intelligence_signals categories don't match (PROACTIVE/REACTIVE/PREDICTIVE required)
  **FIX:** Remove intelligence_signals insert (not critical for seed to work)
*/
