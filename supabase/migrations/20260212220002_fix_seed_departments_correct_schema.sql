/*
  # Fix seed_active_context departments schema

  Updates departments INSERT to match actual schema:
  - Use department_code instead of department_type
  - Remove is_active (doesn't exist)
  - Add required fields like description
*/
...
BEGIN
  ...
  IF v_context.care_setting = 'FACILITY' OR v_context.service_model = 'AGENCY_FACILITY' THEN
    ...
    SELECT id INTO v_dept_nursing_id FROM departments WHERE agency_id = v_agency_id AND department_code = 'NURSING' LIMIT 1;
