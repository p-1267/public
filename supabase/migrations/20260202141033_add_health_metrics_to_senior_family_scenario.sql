/*
  # Add Health Metrics to Senior + Family Scenario
  
  ## Purpose
  Update the senior/family scenario seeder to also seed device integration
  and health metrics data for a complete showcase experience.
  
  ## Changes
  - Call `seed_device_integration_showcase` after creating resident
  - Include device/metrics info in return value
*/
