/*
  # Fix seed to use correct residents schema

  Changes:
  - Remove room_number, risk_level, is_active columns
  - Add status field (lowercase 'active')
  - Add metadata jsonb field with room_number, care_level, risk_level
*/
