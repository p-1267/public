/*
  # Fix Seed Function to Match Actual Schema
  
  Updates seed function to use correct column names from actual tables.
*/
...
BEGIN
  ...
  -- Add medications (using correct schema)
  ...
  INSERT INTO resident_medications (
    ...
    prescriber_name, is_active, start_date, special_instructions
  )
  VALUES
    (
      v_medication_1_id,
  ...
  -- Add appointments (using correct schema)
