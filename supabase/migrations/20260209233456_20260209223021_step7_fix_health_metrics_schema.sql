/*
  # Step 7: Fix health_metrics schema
  
  Changes:
  - Use metric_type instead of metric_name
  - Use value_numeric instead of metric_value
  - Use unit instead of unit_of_measure
*/
...
BEGIN
  ...
  -- Add health metrics with correct schema
