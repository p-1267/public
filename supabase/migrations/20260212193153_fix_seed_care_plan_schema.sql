/*
  # Fix resident_care_plan_anchors schema match
*/
...
BEGIN
  ...
  INSERT INTO resident_care_plan_anchors (resident_id, dietary_restrictions, mobility_assistance_needs, entered_by) VALUES (v_resident.id, 'Low sodium diet for hypertension', 'Minimal assistance needed', COALESCE(v_admin_user_id, v_caregiver_user_id, v_senior_user_id)) ON CONFLICT DO NOTHING;
