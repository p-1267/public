/*
  # Fix seed_active_context appointments title requirement
  
  ## Changes
  - Add title field for appointments
*/
...
BEGIN
  ...
  VALUES
    (v_resident.id, 'CHECKUP', 'Annual Physical Exam', CURRENT_TIMESTAMP + INTERVAL '3 days', 'Dr. Smith', 'Main Clinic', 'SCHEDULED'),
    (v_resident.id, 'LABWORK', 'Routine Blood Work', CURRENT_TIMESTAMP + INTERVAL '1 week', 'Quest Labs', 'Laboratory', 'SCHEDULED')
  ON CONFLICT DO NOTHING;
