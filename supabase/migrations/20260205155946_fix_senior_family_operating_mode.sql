/*
  # Fix Senior Family Scenario Operating Mode
  
  Use correct table: senior_operating_mode (not resident_access_tokens)
  Correct columns: mode, enabled_by, enabled_at, reason
*/
...
BEGIN
  ...
  -- Create user profiles (no agency_id for senior/family)
  ...
  -- Set operating mode to SELF_MANAGE (correct table and columns)
