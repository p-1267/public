/*
  # Fix seed_active_context health_metrics schema mismatch

  **BLOCKER:** health_metrics uses value_numeric not value
  **FIX:** Update seed_active_context to use correct column name
*/
...
BEGIN
  ...
  -- DETERMINISTIC entered_by across ALL possible users
  ...
  -- FIXED: Use correct vital_signs schema (vital_type, recorded_at, recorded_by, value as text)
  FOR i IN 0..4 LOOP
    ...
    -- FIXED: Use value_numeric not value
    INSERT INTO health_metrics (resident_id, metric_category, metric_type, value_numeric, unit, recorded_at, measurement_source)
    VALUES
