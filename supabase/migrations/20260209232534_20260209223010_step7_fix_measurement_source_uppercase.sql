/*
  # Step 7 - Fix measurement_source to use MANUAL_ENTRY
*/
...
DECLARE
  ...
  v_med1_id uuid; v_med2_id uuid; v_task1_id uuid; v_task2_id uuid; v_task3_id uuid; v_category_id uuid;
...
BEGIN
  ...
  IF v_category_id IS NULL THEN
    ...
    VALUES (gen_random_uuid(), v_agency_id, 'Medication Administration', 'clinical', 'high', 'A', true, false, true, 1, now(), now()) RETURNING id INTO v_category_id;
  END IF;
  ...
  RETURN jsonb_build_object('status', 'success', 'resident_id', v_senior_resident_id, 'family_user_id', v_family_user_id, 'caregiver_id', v_caregiver_user_id, 'medication_ids', jsonb_build_array(v_med1_id, v_med2_id), 'task_count', 5);
END;
$$;
