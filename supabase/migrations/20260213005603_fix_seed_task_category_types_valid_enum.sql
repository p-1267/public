/*
  # Fix seed_active_context task_categories to use valid category_type enum values

  ## Changes
  - Use 'clinical' instead of 'medication'
  - Use 'monitoring' instead of 'vital_signs'
  - Use 'nutrition' instead of 'meal'

  ## Fixes
  - ERROR: new row for relation "task_categories" violates check constraint "task_categories_category_type_check"
  - Valid values: clinical, nutrition, cooking, hygiene, housekeeping, cleaning, monitoring, external, temporary, emergency
*/
...
BEGIN
  ...
  -- Get or create task categories (use valid category_type enum values)
