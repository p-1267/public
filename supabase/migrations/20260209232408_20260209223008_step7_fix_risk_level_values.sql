/*
  # Step 7 - Fix risk_level to use A/B/C values
*/
...
BEGIN
  ...
  VALUES (
    gen_random_uuid(), v_agency_id, 'Eleanor Martinez', '1945-03-15', 'active',
    '{"room": "215B", "floor": 2}'::jsonb, now(), now()
  )
  ...
  VALUES (
    ...
    '{"times": ["09:00"]}'::jsonb, 'Dr. Smith', false, false, CURRENT_DATE, true,
    v_caregiver_user_id, 'en-US', now(), now()
  )
  ...
  VALUES (
    ...
    '{"times": ["08:00", "20:00"]}'::jsonb, 'Dr. Smith', false, false, CURRENT_DATE, true,
    v_caregiver_user_id, 'en-US', now(), now()
  )
  ...
  INSERT INTO health_metrics (id, resident_id, metric_category, metric_type, value_numeric, unit, confidence_level, measurement_source, recorded_at, synced_at, created_at)
  VALUES (gen_random_uuid(), v_senior_resident_id, 'vitals', 'blood_pressure_systolic', 128, 'mmHg', 'high', 'manual', now() - interval '2 hours', now(), now());

  INSERT INTO health_metrics (id, resident_id, metric_category, metric_type, value_numeric, unit, confidence_level, measurement_source, recorded_at, synced_at, created_at)
  VALUES (gen_random_uuid(), v_senior_resident_id, 'vitals', 'blood_pressure_diastolic', 82, 'mmHg', 'high', 'manual', now() - interval '2 hours', now(), now());

  INSERT INTO health_metrics (id, resident_id, metric_category, metric_type, value_numeric, unit, confidence_level, measurement_source, recorded_at, synced_at, created_at)
  VALUES (gen_random_uuid(), v_senior_resident_id, 'vitals', 'heart_rate', 72, 'bpm', 'high', 'manual', now() - interval '2 hours', now(), now());
