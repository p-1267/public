/*
  # Fix seed_active_context intelligence_signals schema

  **BLOCKER:** intelligence_signals uses different column names
  **FIX:** Update to use correct schema: category, title, description
*/
