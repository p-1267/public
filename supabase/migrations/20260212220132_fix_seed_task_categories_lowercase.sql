/*
  # Fix seed_active_context task_categories lowercase

  Updates category_type values to lowercase as per constraint.
  Valid values: 'clinical', 'nutrition', 'hygiene', etc.
*/
...
BEGIN
  ...
  VALUES
    ...
    (gen_random_uuid(), 'Personal Hygiene', 'hygiene', true)
  ON CONFLICT DO NOTHING;
