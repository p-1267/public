/*
  # Fix Test RPC Risk Level Values

  ## Purpose
  Update create_task_with_simulation_tag to use correct risk_level values: A, B, C
*/

-- Drop and recreate with correct defaults
...
BEGIN
  INSERT INTO tasks (
    ...
    COALESCE(p_task_data->>'risk_level', 'B'), -- Use B (medium risk) as default
...
'Test helper: Creates task with is_simulation flag. Risk levels must be A/B/C.';
