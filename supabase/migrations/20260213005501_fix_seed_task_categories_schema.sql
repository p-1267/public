/*
  # Fix seed_active_context task_categories INSERT to match actual schema

  ## Changes
  - Use category_type instead of category_label
  - Add description field

  ## Fixes
  - ERROR: column "category_label" of relation "task_categories" does not exist
*/
...
BEGIN
  ...
  VALUES
    ('c0000000-0000-0000-0000-000000000001', 'Medication Administration', 'medication', 'Administer prescribed medications'),
    ('c0000000-0000-0000-0000-000000000002', 'Vital Signs Check', 'vital_signs', 'Check and record vital signs'),
    ('c0000000-0000-0000-0000-000000000003', 'Meal Assistance', 'meal', 'Assist resident with meals')
  ON CONFLICT (id) DO NOTHING;

  SELECT id INTO v_category_med_id FROM task_categories WHERE category_type = 'medication' LIMIT 1;
  SELECT id INTO v_category_vitals_id FROM task_categories WHERE category_type = 'vital_signs' LIMIT 1;
  SELECT id INTO v_category_meal_id FROM task_categories WHERE category_type = 'meal' LIMIT 1;
