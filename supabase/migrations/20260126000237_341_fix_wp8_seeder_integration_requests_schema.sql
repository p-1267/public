/*
  # Fix WP8 Showcase Seeder - Match integration_requests Schema
  
  Fix to match actual schema:
  - request_id (not provider_request_id)
  - provider_type and provider_name are required
*/
