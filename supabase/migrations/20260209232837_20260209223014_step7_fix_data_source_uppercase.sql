/*
  # Step 7 - Fix data_source to use MANUAL_ENTRY
*/
...
BEGIN
  ...
  VALUES 
    (gen_random_uuid(), v_senior_resident_id, 'vitals', 'blood_pressure_systolic', 128, 'mmHg', 'HIGH', 'MANUAL_ENTRY', now() - interval '2 hours', now(), now(), 'MANUAL_ENTRY'),
    (gen_random_uuid(), v_senior_resident_id, 'vitals', 'blood_pressure_diastolic', 82, 'mmHg', 'HIGH', 'MANUAL_ENTRY', now() - interval '2 hours', now(), now(), 'MANUAL_ENTRY'),
    (gen_random_uuid(), v_senior_resident_id, 'vitals', 'heart_rate', 72, 'bpm', 'HIGH', 'MANUAL_ENTRY', now() - interval '2 hours', now(), now(), 'MANUAL_ENTRY');
