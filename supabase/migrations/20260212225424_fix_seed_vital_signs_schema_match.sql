/*
  # Fix seed_active_context vital_signs schema mismatch

  **BLOCKER:** seed_active_context uses wrong column names for vital_signs
  - Uses: measurement_type, measured_at, measured_by
  - Should be: vital_type, recorded_at, recorded_by
  - value column is TEXT not numeric

  **FIX:** Update seed_active_context to match actual vital_signs schema
*/
