...
export function Step2BidirectionalWiringTest() {
  ...
  const runVerifier = async () => {
    ...
    try {
      const showcaseAgencyId = '00000000-0000-0000-0000-000000000001';

      const { data, error } = await supabase.rpc('verify_step2_bidirectional_wiring', {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">
            Step 2: Bidirectional Cross-Scenario Wiring Verification
          </h1>
          <p className="text-xl text-slate-600">
            Verifies family inputs route to supervisors, caregivers, and brain pipeline
          </p>
        </div>

        <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Test Coverage</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="font-semibold text-blue-900 mb-2">Family Write Access</div>
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• RLS-enforced observation submission</li>
                <li>• Idempotency and rate limiting</li>
                <li>• Audit logging with actor attribution</li>
              </ul>
            </div>
            <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
              <div className="font-semibold text-purple-900 mb-2">Supervisor Routing</div>
              <ul className="text-sm text-purple-800 space-y-1">
                <li>• Exception queue population</li>
                <li>• Process and route to caregivers</li>
                <li>• Resolution tracking</li>
              </ul>
            </div>
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="font-semibold text-green-900 mb-2">Unified Timeline</div>
              <ul className="text-sm text-green-800 space-y-1">
                <li>• Multi-actor attribution</li>
                <li>• All roles see same events</li>
                <li>• Source table tracking</li>
              </ul>
            </div>
            <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
              <div className="font-semibold text-orange-900 mb-2">Brain Intelligence</div>
              <ul className="text-sm text-orange-800 space-y-1">
                <li>• Family inputs → observation_events</li>
                <li>• Brain pipeline consumption</li>
                <li>• Context signal generation</li>
              </ul>
            </div>
          </div>
                      ...
                      <div className="flex-1">
                        ...
                        {check.observation_id && (
                          <div className="text-xs opacity-75 mt-2">
                            Observation ID: {check.observation_id}
                          </div>
                        )}
                        {check.details && (
